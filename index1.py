list = ['?maria-sama ga miteru haru 2nd\n', '.hack//g.u. returner\n', '.hack//g.u. trilogy\n',
        ...
        "akiba's trip the animation\n", "akiba's trip the animation (dub)\n", 'akihabara dennou-gumi\n', 'akikan\n',
        'akikan ova\n', 'akira\n', 'akira (dub)\n', 'akkun to kanojo\n', 'aku no hana\n', 'akudama drive\n',
        ...
        'birdy the mighty decode:02 prologue\n', 'birth\n', 'birthday wonderland\n',
        ...
        'black cat\n', 'black cat (dub)\n', 'black clover\n', 'black clover (tv)\n', 'black clover (tv) (dub)\n',
        'black clover: jump festa 2016 special\n', 'black clover: jump festa 2016 special (dub)\n',
        ...
        'boku no hero academia the movie 2: heroes:rising (dub)\n', 'boku no hero academia the movie: futari no hero\n',
        ...
        'code geass: boukoku no akito movie\n', 'code geass: fukkatsu no lelouch\n',
        ...
        'code:breaker ova\n', 'code:realize: sousei no himegimi\n', 'code:realize: sousei no himegimi (dub)\n',
        'colorful\n', 'colorful (movie)\n', 'coluboccoro\n', 'comet lucifer\n', 'comic girls\n', 'comic party (dub)\n',
        ...
        "dennou sentai voogie's★angel\n", "dennou sentai voogie's★angel (dub)\n", 'denpa kyoushi (tv)\n',
        ...
        'devilman the birth of devilman\n', 'devilman the demon bird\n', 'devilman: crybaby\n',
        ...
        'doraemon (2005) (dub)\n', 'doraemon (2005) season 2 (dub)\n', 'doraemon movie – nobita and the wind wizard\n',
        ...
        "dragon ball movie 2: sleeping princess in devil's castle (dub)\n",
        ...
        'dramatical murder ova: data_xx_transitory (dub)\n', 'dream festival!\n', 'dream festival! r\n',
        'dream hunter rem\n', 'drifters\n', 'drifters (dub)\n', 'drifters ova\n', 'drifters specials\n',
        ...
        'fate/grand order: zettai majuu sensen babylonia (dub)\n', 'fate/kaleid liner prisma illya zwei!\n',
        'fate/kaleid liner prisma☆illya (dub)\n', 'fate/kaleid liner prisma☆illya 2wei herz!\n',
        'fate/kaleid liner prisma☆illya 2wei herz! specials\n', 'fate/kaleid liner prisma☆illya 2wei! (dub)\n',
        'fate/kaleid liner prisma☆illya 2wei! ova\n', 'fate/kaleid liner prisma☆illya 2wei! specials (dub)\n',
        'fate/kaleid liner prisma☆illya 3rei!!\n', 'fate/kaleid liner prisma☆illya 3rei!! specials\n',
        'fate/kaleid liner prisma☆illya movie: oath under snow special\n',
        'fate/kaleid liner prisma☆illya movie: sekka no chikai\n', 'fate/kaleid liner prisma☆illya ova\n',
        'fate/stay night (dub)\n', "fate/stay night movie: heaven's feel - i. presage flower\n",
        "fate/stay night movie: heaven's feel - i. presage flower (dub)\n",
        "fate/stay night movie: heaven's feel - ii. lost butterfly\n",
        "fate/stay night movie: heaven's feel - ii. lost butterfly (dub)\n",
        "fate/stay night movie: heaven's feel - iii. spring song (camrip)\n",
        'fate/stay night: unlimited blade works\n', 'fate/stay night: unlimited blade works (dub)\n',
        'fate/stay night: unlimited blade works (dub) - movie\n', 'fate/stay night: unlimited blade works (tv)\n',
        'fate/stay night: unlimited blade works (tv) (dub)\n',
        'fate/stay night: unlimited blade works (tv) 2nd season\n',
        'fate/stay night: unlimited blade works (tv) 2nd season - sunny day\n',
        'fate/stay night: unlimited blade works (tv) 2nd season (dub)\n',
        'fate/stay night: unlimited blade works 2nd season - sunny day (dub)\n', 'fate/zero (dub)\n',
        ...
        'fugou keiji: balance:unlimited\n', 'fugou keiji: balance:unlimited (dub)\n', 'fujiko fujio a no mumako\n',
        ...
        'ghost in the shell: arise - border 3\n', 'ghost in the shell: arise - border:1 ghost pain (dub)\n',
        'ghost in the shell: arise - border:2 ghost whispers (dub)\n',
        'ghost in the shell: arise - border:3 ghost tears (dub)\n',
        'ghost in the shell: arise - border:4 ghost stands alone\n',
        'ghost in the shell: arise - border:4 ghost stands alone (dub)\n',
        ...
        "goblin slayer: goblin's crown\n", "goblin slayer: goblin's crown (dub)\n",
        ...
        'high☆speed!: free! starting days (dub)\n', 'highlander: search for vengeance\n',
        ...
        'hinako note\n', 'hinamatsuri\ufeff\n', 'hinamatsuri (dub)\n', 'hinata no aoshigure - movie\n',
        'hinomaruzumou\n', 'hinomaruzumou (dub)\n', 'hipira-kun\n', 'hirune hime: shiranai watashi no monogatari\n',
        'hisone to maso-tan\n', "history's strongest disciple kenichi (dub)\n", 'hitohira\n',
        ...
        'jojo`s bizarre adventure\n', "jojo's bizarre adventure (2000) (dub)\n",
        "jojo's bizarre adventure (2012) (dub)\n", "jojo's bizarre adventure (dub)\n", 'joker game\n',
        ...
        'kyoukai no kanata episode 0: shinonome\n', "kyoukai no kanata movie 1: i'll be here - kako-hen (dub)\n",
        "kyoukai no kanata movie 2: i'll be here - mirai-hen (dub)\n",
        ...
        'la corda d`oro ~primo passo special\n', 'la corda d’oro secondo passo\n', 'labyrinth of flames (dub)\n',
        ...
        'legend of crystania: resurrection of the god`s king\n', 'legend of crystania: the motion picture (dub)\n',
        ...
        "lupin iii: ai no da capo - fujiko's unlucky days (dub)\n", 'lupin iii: babylon no ougon densetsu\n',
        ...
        'lupin iii: napoleon no jisho wo ubae\n', 'lupin iii: napoleon no jisho wo ubae (dub)\n',
        ...
        'mahou shoujo madoka★magica movie 1: hajimari no monogatari (dub)\n',
        ...
        'mangaka-san to assistant-san to ova\n', 'mangirl!\n', 'mangirl! ova\n', 'manyuu hikenchou\n',
        'maou dante (dub)\n',
        ...
        'mobile suit gundam unicorn re:0096 (dub)\n', 'mobile suit gundam wing (dub)\n',
        ...
        'mobile suit gundam-san\n', "mobile suit gundam: char's counterattack (dub)\n",
        ...
        "mobile suit gundam: the 08th ms team - miller's report (dub)\n",
        ...
        'pokemon best wishes! season 2 special: dent and takeshi! gyarados`s imperial rage!!\n',
        ...
        'pokemon movie 19: volcanion to karakuri no magiana - movie\n',
        ...
        'pokemon xy: odemashi ko majin fuupa (dub)\n', 'pokemon xy: ring no choumajin hoopa (dub)\n', 'pokemon xy&z\n',
        ...
        'quanzhi gaoshou zhi dianfeng rongyao\n', "queen's blade rurou no senshi (dub)\n", "queen's blade: grimoire\n",
        "queen's blade: gyokuza wo tsugu mono (dub)\n", "queen's blade: rebellion (dub)\n",
        "queen's blade: rurou no senshi (tv)\n", "queen's blade: unlimited\n", 'queen’s blade – vanquished specials \n',
        'queen’s blade gyokuza wo tsugumono \n', 'queen’s blade premium visual book ova\n',
        'queen’s blade rebellion – a saint’s agony ova\n',
        'queen’s blade rebellion – siggy’s passionate sacred pose lessons ova\n',
        'queen’s blade vanquished queens ova\n', 'queen’s blade: rebellion\n', 'queen’s blade: rebellion specials \n',
        'queen’s blade: rurou no senshi ova\n', 'queen’s blade: vanquished ova\n', 'r-15\n', 'r.o.d ova (dub)\n',
        ...
        're:zero kara hajimeru isekai seikatsu - memory snow\n', 're:zero kara hajimeru isekai seikatsu (dub)\n',
        're:zero kara hajimeru isekai seikatsu 2nd season\n',
        're:zero kara hajimeru isekai seikatsu 2nd season (dub)\n',
        ...
        'time jam：valerian and laureline (dub)\n', 'time of eve\n', 'time of eve (dub)\n',
        ...
        'yawara! a fashionable judo girl\n', 'yawara! sore yuke koshinuke kid!!\n',
